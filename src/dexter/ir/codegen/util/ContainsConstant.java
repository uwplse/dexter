...
public class ContainsConstant implements Visitor<Boolean> {
  Stack<String> trace = new Stack<>();
  List<FuncDecl> fns;

  public ContainsConstant(String name, List<FuncDecl> fns) {
  ...
  @Override
  public Boolean visit(Bound e) { return false; }
  ...
  public Boolean visit(IntLitExpr e) {
    return e.value() > 4 && e.canModelAsVar();
  }
